...
**Response**: Thank you for these comments. We agree that the use cases and the jargon could be simplified to make the text more readable and attractive. 
Too address these recommendations, we: (1) added a brief paragraph in the introduction describing basic Git and Github workflows, directing readers to other references containing more technical and in-depth information about these platforms;
