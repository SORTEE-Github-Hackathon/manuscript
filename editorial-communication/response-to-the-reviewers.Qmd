...
As mentioned above ([R1.1](#sec-R1.1), [E1.1](#sec-E1.1)), we were able to reduce jargon by making it clear in the introduction that our aim was not to *teach* the use of git and GitHub, and by discussing a basic git workflow early on.
:::
...
We've added a supplemental document better explaining *how* we made these quantifications (see also our response to reviewer 2 [R2.2](#sec-R2.2)).
However, we have taken the advice of reviewer 1 in other comments ([R1.4](#sec-R1.4), [R1.1](#sec-R1.1)) to reduce the number of use cases and re-order them.
:::
