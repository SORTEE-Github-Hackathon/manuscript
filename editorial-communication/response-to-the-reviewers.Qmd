...
We have addressed all the suggestions that you and the reviewers provided and, as before, we provide a point-by-point detailed response discussing each comment or suggestion. Our responses are mirror-indented and written in black, while the editor's and reviewers' comments are numbered and highlighted in color. To facilitate the review, we have also included indented extracts from the text, highlighting the changes we made in orange. The line numbers in our responses correspond to those in the revised manuscript.
...
We now discuss the possibility of integrating GitHub into existing workflows on Overleaf, Google Drive, and DropBox among others to collaboratively write scientific manuscripts, in the section "Writing a manuscript" <!--# add line numbers -->. We refer to Table 1 for further details on these integrations.
