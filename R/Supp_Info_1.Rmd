...
We determined the minimum and maximum degree of collaboration from these levels for each GitHub use case.
...
The collaborative Google Spreadsheet is also accessible at the following link: [https://docs.google.com/spreadsheets/d/1zCRgctjfjE2xZN9MkqfFh222K6bvVvA3gT0UdkL_CS8/edit#gid=0](https://docs.google.com/spreadsheets/d/1zCRgctjfjE2xZN9MkqfFh222K6bvVvA3gT0UdkL_CS8/edit#gid=0). 
...
We used the color palette "turbo" from the R package [viridis](https://cran.r-project.org/web/packages/viridis/vignettes/intro-to-viridis.html#the-color-scales):
