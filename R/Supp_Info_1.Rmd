...
knitr::kable(to_print, 
             label = "data",
             caption = "Indices of technical difficulty and degree of collaboration for each GitHub use case. The first column lists the GitHub use cases that were addressed in the main text. Indices were assessed collaboratively following the steps in Appendix S1.1.",
              align = c('l','c','c','c','c')) %>% 
