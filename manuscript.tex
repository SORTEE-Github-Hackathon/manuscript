This manuscript
(\href{https://SORTEE-Github-Hackathon.github.io/manuscript/v/1498796835167c3f7d1f4135eca274b5e7d6346c/}{permalink})
was automatically generated
from \href{https://github.com/SORTEE-Github-Hackathon/manuscript/tree/1498796835167c3f7d1f4135eca274b5e7d6346c}{SORTEE-Github-Hackathon/manuscript@1498796}
on June 13, 2022.
...
Though the templates are useful for quickly starting up a new website, users are able to fully customize their Pages websites (for technical details of customizing GitHub Pages site see\textsuperscript{\protect\hyperlink{ref-MXxgZJ45}{28}}).
...
For this reason, scientists who share code and data through GitHub are strongly encouraged to also submit GitHub repository content to a long-term data archive\textsuperscript{\protect\hyperlink{ref-1Du6fzB8g}{29}}.
...
Linking one's GitHub repository with Zenodo, etc. to obtain a DOI helps work become findable, gives proper attribution, and can ensure long-term stability\textsuperscript{\protect\hyperlink{ref-iIEKCTLU}{30}}.
...
Even if code lacks detailed annotation, it shows the exact steps taken to conduct an analysis, and therefore provides the most detailed look into how to reproduce a given analysis\textsuperscript{\protect\hyperlink{ref-uBJwnPbq}{31}}.
This is important in light of the reproducibility crisis\textsuperscript{\protect\hyperlink{ref-1HZdsK5Kn}{32}} and will become increasingly important to the collective scientific enterprise as advances in computing power and accessibility unlock the ability to conduct `big data' meta research with data that has already been collected by others.
...
Version control\textsuperscript{\protect\hyperlink{ref-K7nbP1Ty}{33}} features also allow users to make progress and changes without worrying about irreparably writing over someone else's work.
...
Periodic code review\textsuperscript{\protect\hyperlink{ref-hm9PaCLD}{34}} can also help advisors identify errors early in the process, and inform further training and mentorship to fill gaps in skills.
...
We wrote this manuscript using Manubot\textsuperscript{\protect\hyperlink{ref-YuJbg3zO}{35}}, a collaborative manuscript platform that uses Markdown for writing and GitHub for storing and tracking changes to a manuscript over time.
...
For more examples of Manubot being used for manuscripts, see\textsuperscript{\protect\hyperlink{ref-YuJbg3zO}{35}}.
...
Other tools can also be used for version control of scientific manuscripts including R Markdown via the bookdown package (\url{https://bookdown.org/}), jupyter notebooks\textsuperscript{\protect\hyperlink{ref-i4FOZpjN}{36}} and a relatively new tool, Quarto (\url{https://quarto.org}).
...
rOpenSci's efforts have resulted in many well-used R packages for ecology research including rfishbase\textsuperscript{\protect\hyperlink{ref-Xsdcv6q}{37}} and taxize\textsuperscript{\protect\hyperlink{ref-FVBWKkZu}{38}}.
...
Cynically, there is also more insurance against nefarious colleagues that may be tempted to distort results\textsuperscript{\protect\hyperlink{ref-18PTmKJkq}{39}}.
...
Publishing the data and reproducible workflows along with the manuscript allows any reader to review the analysis and reproduce the experiment\textsuperscript{\protect\hyperlink{ref-NOgBWVAr}{40}}.
...
The development of research code continues, and so does the need to consider project continuity, especially in EEB where graduate students, research assistants, and postdoctoral fellows often hold relatively short-term positions\textsuperscript{\protect\hyperlink{ref-D4C4k4ak}{41}}.
...
As projects or contracts end, there should be a handover period of this code in order for the next cohort of researchers to reuse what was already developed\textsuperscript{\protect\hyperlink{ref-4ny1onB0}{8},\protect\hyperlink{ref-D4C4k4ak}{41}}.
...
Additionally, GitHub allows for repositories and organizations to have designated Code Owners\textsuperscript{\protect\hyperlink{ref-s91uGRZ2}{42}}; these code owners can change through time allowing for the transition of code from one cohort of researchers to the next\textsuperscript{\protect\hyperlink{ref-iIEKCTLU}{30}}.
...
There have been many calls for researchers outside of the software development community to join the 73 million GitHub users for their collaborative research\textsuperscript{\protect\hyperlink{ref-10ghgV3S8}{3},\protect\hyperlink{ref-1Du6fzB8g}{29},\protect\hyperlink{ref-UsTxAq4f}{43}}.
...
2. \textbf{Consider taking free courses.} such as those from Software Carpentry\textsuperscript{\protect\hyperlink{ref-pjy75gHr}{45}} and sharing these courses with your lab members or colleagues. \\
...
\CSLLeftMargin{25. }
\CSLRightInline{Xie, Y., Allaire, J. J. \& Grolemund, G. \emph{R Markdown: the definitive guide}. (CRC Press, Taylor \& Francis Group, 2019).}
...
\CSLLeftMargin{28. }
\CSLRightInline{Dawson, C. \& Straub, B. \emph{Building tools with GitHub: customize your workflow}. (O'Reilly, 2016).}
