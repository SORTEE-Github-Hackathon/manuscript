...
Although more time-consuming when compared to using conventional text processors, GitHub has many features that can allow for a powerful collaborative workflow when writing manuscripts [@doi:10.1186/1751-0473-8-7].
...
For instance, authors who prefer writing in LaTeX or Markdown can link their new or existing projects to GitHub via the Git bridge and GitHub Synchronization features ([Table 1](#tbl:compare)), which are available through premium subscriptions and university partnerships to Overleaf   [@url:https://www.overleaf.com/learn/how-to/Using_Git_and_GitHub], through HackMD (<https://hackmd.io>), and others. 
