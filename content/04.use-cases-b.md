...
GitHub can also be used as a hub during the peer review process of a manuscript or research software.
If code is made available to reviewers of a manuscript, they may be able to offer more helpful suggestions on how to explain methodology and may even make comments on the code itself, potentially catching bugs or errors before publication.
using github issues (Box 1) to organize and respond to reviewer comments on a manuscript.
See example [here](https://github.com/BrunaLab/HeliconiaDemography/issues?q=is%3Aissue+label%3A%22reviewer+comment%22+)
