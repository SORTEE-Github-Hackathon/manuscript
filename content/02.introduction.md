...
With over 73 million registered users, GitHub and its underlying version control system, Git, are the most commonly used web-platform for documentation and collaboration on computer code [@https://github.com/about].
In GitHub, users can participate in projects, contribute, report and discuss code issues, and search for existing code as well as publish their own code in the web-platform.
