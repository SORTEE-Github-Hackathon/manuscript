...
Github is a valuable tool/platform to support both learning and teaching as a submission platform (to host their work and submit their course assignments and
projects). Therefore Github can be used as a way to host course content, through basic GitHub, the organizations feature, and GitHub classroom.Therefore teachers can utilize GitHub as typical learning management systems to improve assignment submission, grading and feedback systems [@doi:10.2190/1002-1T50-27G2-H3V7].
It is also important to consider that GitHub provides a graph view to visualize and summarize students project activities and reports[@doi:10.1145/2675133.2675284]. Therefore, by visualizing a summary of classroom and project activities; a graph view allowed instructors/trainers and teachers to easy obtain well-detailed view of trainee and student class activity which his provided by the commit history. Moreover, version control as a part of Github can help students for their future work. students can benefit from Github in which Students with experience using version control are more prepared and qualified to work in industry[@doi:10.1145/2445196.2445486].

Saeed: I hope it is updated online too :)
