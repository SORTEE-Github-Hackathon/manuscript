...
In this context, small modifications to code and data can be frequently committed and automatically tested (as in continuous integration and continuous deployment practices).
This allows for early detection and correction of errors [@doi:10.1109/MS.2014.58], potentially improving confidence in scientific development by minimizing software errors [see @doi:10.12688/f1000research.5930.2].
