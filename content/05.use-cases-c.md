...
Third...
Instantly share code, notes, files and snippets by [Github Gist](https://gist.github.com/). Each gist is a kind of Github repository, which can be forked, starred or downloaded. Gists will be associated with your Github account can be public or private. 
