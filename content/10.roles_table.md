...
|:-----------------|:---------------------------------------------------|:-------------------------------------|:---------------------------------------------------------------|:--------------------------------------------------------|:-----------------------------------------------------|:-------------------------------------------------|:-------------------------------------------------------|
| Project manager  | Set contributor permissions, share code of conduct | Project descritption, citation, DOIs | Assign tasks to collaborators                                  | Open conversations about project directions and writing | Approve and incorporate edits to code and/or writing |                                                  | Share up-to-date reports, figures, or draft manuscript |
| Co-author        | Edit Markdown text or add files                    |                                      | Propose task for code contributors (e.g. analyses and figures) | Discuss proposed changes to manuscript                  |                                                      |                                                  |                                                        |
...
| Community        |                                                    |                                      | Suggest additional features and report bugs                    | Ask questions about data and code                       |                                                      | Create a linked, editable copy of the repository | Project website                                        |
